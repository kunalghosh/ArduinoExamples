...
The port filters out Bluetooth and only looks for /dev/tty strings, this worked on Mac OS X Mavericks and Chrome 41 but not sure if its the same on Windows.
